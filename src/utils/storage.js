...
const supabaseStorage = {
  ...
  async getParticipants() {
    const data = await supabaseRequest('participants', 'GET', {
      filters: '?select=id,name,email,is_admin,current_day,is_active,start_date,completed_days,submissions,metrics,removed_at,reactivated_at,created_at&order=created_at.asc',
    });
